...
function process_node(profile, node, result)
  ...
  if tags.wheelchair == 'yes' then
    result.classes = result.classes or {}
    table.insert(result.classes, 'accessible')
  else
    result.classes = result.classes or {}
    table.insert(result.classes, 'inaccessible')
  end

  -- add amenity type tags
  -- amenity type 1: add female restroom amenity tags
  if tags.amenity == 'toilets' and tags.female == 'yes' then
    result.classes = result.classes or {}
    table.insert(result.classes, 'restroom')
    table.insert(result.classes, 'female_restroom')
  end
  -- amenity type 2: add male restroom amenity tags
  if tags.amenity == 'toilets' and tags.female == 'yes' then
    result.classes = result.classes or {}
    table.insert(result.classes, 'restroom')
    table.insert(result.classes, 'male_restroom')
  end
  -- amenity type 3: add nursing room amenity tags
  if tags.amenity == 'nursing_room' then
    result.classes = result.classes or {}
    table.insert(result.classes, 'nursing_room')
  end
...
function process_way(profile, way, result)
  ...
  -- add accessibility class
  if way.tags.wheelchair == 'yes' then
    result.classes = result.classes or {}
    table.insert(result.classes, 'accessible')
  else
    result.classes = result.classes or {}
