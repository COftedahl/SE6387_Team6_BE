...
describe("Filtering System unit tests", () => {
  ...
  test("get available amenities succeeds with filters", async () => {
  ...
  test("get amenity details succeeds with filters", async () => {
  ...
  test("get available amenities of type succeeds with filters", async () => {
